...
Примечание редакции: [оригинальный пост](http://blog.method.ac/design/youre-already-a-pretty-good-designer/) был опубликован аж в 2011 году, с тех пор курсы так и не запустились, а авторы решили, что курсы — не самый подходящий формат для их целей.
